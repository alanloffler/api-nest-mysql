...
export class CategoriesService {
    ...
    async create(createCategoryDto: CreateCategoryDto, activeUser: IActiveUser) {
        ...
        throw new HttpException('Category created', HttpStatus.CREATED);
    }
    ...
    async update(id: number, updateCategoryDto: UpdateCategoryDto, activeUser: IActiveUser): Promise<void> {
    ...
    async restore(id: number, activeUser: IActiveUser): Promise<void> {
        ...
        if (softDeletedCategories) {
            if (softDeletedCategories.deletedAt === null) {
                ...
                throw new HttpException('Category restored', HttpStatus.OK);
            }
        } else {
